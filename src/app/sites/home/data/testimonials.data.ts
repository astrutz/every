...
export const testimonials: Testimonial[] = [
  ...
  // },
  {
    ...
    text: '"We had just started developing a new system using Angular when Alex joined our team. In no time, he familiarized himself with the system and began contributing to its further development, bringing in numerous ideas and improvements. Alex doesn’t just write code; he anticipates future needs. Everyone wants Alex on their team!"',
